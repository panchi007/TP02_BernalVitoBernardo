...
import ar.edu.unju.fi.ejercicio06.model.PagoEfectivo;
import ar.edu.unju.fi.ejercicio06.model.PagoTarjeta;
import ar.edu.unju.fi.ejercicio06.model.Producto;
...
public class Main {
    ...
    private static ArrayList<Producto> cargarProductos() {
        ...
        productos.add(new Producto("P002", "Laptop", 1000.0, Producto.OrigenFabricacion.BRASIL, Producto.Categoria.INFORMATICA, false)); // No disponible
